...
-- config.window_background_image = '/home/charalambos/Pictures/papes/computer.png'

local color_scheme = "alienblood"
...
-- color scheme
local palette = {
  bg = "#1e1e1e",         -- dark gray-black editor background
  fg = "#d4d4d4",         -- light gray for primary text
  accent = "#1e1e1e",     -- soft blue for borders and highlights
  tabfg = "#1e1e1e",      -- warm yellow for active tab/cursor
  tabbg = "#252526",      -- slightly lighter dark gray for tab/activity bar
  tabtxt = "#63ef18",     -- mid-tone gray for inactive tab text
  fgleader = "#64c2b5",   -- teal for suggestions/leader foreground
  bgleader = "#3c3c3c",   -- darker gray for selection/highlight background
}

local colors = {
  border = palette.accent,               -- muted dark green
  tab_bar_active_tab_fg = palette.tabfg, -- soft blue
  tab_bar_active_tab_bg = palette.tabbg, -- dark green
  tab_bar_text = palette.tabtxt,         -- mid gray
  arrow_foreground_leader = palette.fgleader, -- near-white
  arrow_background_leader = palette.bgleader,  -- dark muted green
}
